...
orsi_szin_1 = [104,210,225]
orsi_szin_rikito_rozsaszin = [247, 9, 124]
orsi_szin_zold = [36, 229, 11]
orsi_szin_kek = [7, 231, 247]
...
class PhysicsDemo:
    ...
    def create_ball(self, point, mass=1.0, radius=45):
    ...
    def draw_ball(self, ball):
        ...
        p = self.flipyv(v)
        r = ball.radius
        pygame.draw.circle(self.screen, orsi_szin_rikito_rozsaszin, p, int(r), 3)
...
##      
        ...
        if len(self.poly_points) > 1:
            ...
            pygame.draw.lines(self.screen, orsi_szin_zold, False, ps, 2)
        
        ### Mouse Contact
        if self.mouse_contact is not None:
            p = self.flipyv(self.mouse_contact)
            pygame.draw.circle(self.screen, orsi_szin_zold, p, 3)
    ...
    def loop(self):       
        for event in pygame.event.get():
            if event.type == QUIT:
                ...
                bp = Vec2d(randint(0,1023),randint(0,767))
